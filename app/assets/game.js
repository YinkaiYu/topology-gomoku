(function topologyGomokuApp() {
  ...
  var TUTORIAL_AUTO_ADVANCE_DELAY = Content.TUTORIAL_AUTO_ADVANCE_DELAY;
  var TUTORIAL_PROMPTS = Content.TUTORIAL_PROMPTS;
  ...
  var DIFFICULTY_ORDER = Content.DIFFICULTY_ORDER;
  ...
  function drawCompletionMorph(ctx, time) {
    ...
    var orientation = ViewLogic.completionOrientation(
      game.completion, viewBlend, jellyScale, restingBounce, sphereCompletion, Morph, time
    );
  ...
  function interactiveViewOrientation(time) {
    return ViewLogic.interactiveOrientation(game.view, time);
  }
