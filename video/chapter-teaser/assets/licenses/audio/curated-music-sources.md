...
The supplied *Footprints* accompaniment was studied for chapter contrast, title punctuation, large-scale dynamic contour and narration space. It is not present as a full-range source in the final mix. All adjacent excerpts meet in an exact 84-frame `qsin` crossfade, with no three-way overlap. The Saint-Saëns excerpt uses source `146.762125–157.612125`: the full-orchestra cadence still lands before frame 12474, its residual decay crosses the Logo reveal for exactly 60 frames, and a 42-frame `qsin` fade suppresses the sustained quiet solo. Music is digitally silent from frame 12534 through the end; sound effects and narration remain digitally silent from frame 12474.
...
| PV segment | Work / recording | Source page |
|---|---|---|
| Opening — boundary question | Erik Satie, *Gnossienne No. 6* — Reinbert de Leeuw | <https://www.youtube.com/watch?v=RD2lk2_UlgE> |
| Opening — seven-world awakening | Maurice Ravel, *Daphnis et Chloé: Lever du jour* — Berliner Philharmoniker / Pierre Boulez / Rundfunkchor Berlin | <https://www.youtube.com/watch?v=wdX5mrp8uE0> |
| ACT. PROLOGUE 方庭 | J. S. Bach, *The Art of Fugue, BWV 1080: Contrapunctus I* — Kimiko Ishizaka | <https://music.kimiko-piano.com/> |
| ACT. I 回廊 | HOYO-MiX, *Symposion of Spectacle* | <https://www.youtube.com/watch?v=XlSZ3_b02SI> |
| ACT. II 环游 | Maurice Ravel, *String Quartet in F major: II. Assez vif, très rythmé* — Emerson String Quartet | <https://www.youtube.com/watch?v=GDs7JHlH6Ds> |
| ACT. III 扭带 | Alexander Scriabin, *Prelude, Op. 67 No. 1* — Vladimir Horowitz | <https://www.youtube.com/watch?v=6X0gKdBxoJs> |
| ACT. IV 瓶界 | Claude Debussy, *Préludes, Book I: La cathédrale engloutie* — Maurizio Pollini | <https://www.youtube.com/watch?v=YIAm3AvG5ok> |
