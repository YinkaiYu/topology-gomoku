...
- Bilibili Toy：已发布专属 adapter 与多设备适配；平台规范见 [`platforms/bilibili.md`](platforms/bilibili.md) 和 [`platforms/bilibili-responsive-guide.md`](platforms/bilibili-responsive-guide.md)，并以官方 Toy 约束和仓库安装的 `toy` skill 为准。
