...
- Bilibili Toy：以 [`platforms/bilibili.md`](platforms/bilibili.md) 为当前适配说明，以 [`platforms/bilibili-responsive-guide.md`](platforms/bilibili-responsive-guide.md) 为多设备参考，并以官方 Toy 约束和仓库安装的 `toy` skill 为准。
