...
| 《足音回归》七流形汇聚与几何转场 | [`cylinder→torus 前`](../../artifacts/pv-transition-scenes-task7/task7-cylinder-to-torus-pre.png)、[`中`](../../artifacts/pv-transition-scenes-task7/task7-cylinder-to-torus-mid.png)、[`后`](../../artifacts/pv-transition-scenes-task7/task7-cylinder-to-torus-post.png)、[`torus→Möbius 中`](../../artifacts/pv-transition-scenes-task7/task7-torus-to-mobius-mid.png)、[`Möbius→Klein 中`](../../artifacts/pv-transition-scenes-task7/task7-mobius-to-klein-mid.png)、[`gallery / outro 前`](../../artifacts/pv-transition-scenes-task7/task7-gallery-withdrawal-before-outro.png)、[`gallery / outro 旁白重叠`](../../artifacts/pv-transition-scenes-task7/task7-gallery-withdrawal-during-outro.png) 与 [`关键帧联系表`](../../artifacts/pv-transition-scenes-task7-contact-sheet.png)；原生 3840 × 2160、60fps。Task 8 按实测音频扩展时间轴后已在 56.15 / 56.29 / 56.62 / 75.47 / 93.58 / 162.90 / 164.82 秒重录；164.82 秒 gallery 在第一条片尾旁白期仍可辨且继续退镜。逐帧 contractId、phase、seek、expectedGeometry、几何 bbox 与像素方差见 [`manifest`](../../artifacts/pv-transition-scenes-task7-manifest.json)，并逐层复核 live runtime 及 expectedGeometry。联系表 SHA-256：`197c9d499b0e3b6fd858bfe4c5f8e2e4f28771be0039d1e67b7a03d4706efe61` |
| 《足音回归》4K 单行字幕与底部基线 | [`6 cue 代表帧`](../../artifacts/pv-caption-scenes-task8/) 与 [`联系表`](../../artifacts/pv-caption-scenes-task8-contact-sheet.png)；覆盖片头、正文“方庭”、有语义问号、长语义分句、球面总结与片尾。真实 Topo Serif 88px、白字 / 4px 黑描边，DOM 零高 marker 实测基线距底 180px；通用底部安全边界 144px，46 cue 可见字形下沿均距底 155px。6 帧均为单行且只显示一个 caption group，代表帧宽 1144–1672px，低于 3456px 安全宽。全量 46 cue 的 seek、字宽、真实基线、字形 bbox、字体与可见组数均持久化在 [`manifest`](../../artifacts/pv-caption-scenes-task8-manifest.json)；联系表 SHA-256：`e3fbf399704e6b35c1e0a783d55850f38c8e154b42808b5a015944c5948ce629`。本地另生成被忽略的 69 秒字幕专审视频 |
