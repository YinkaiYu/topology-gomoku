...
| 《足音回归》4K 单行字幕与底部基线 | [`6 cue 代表帧`](../../artifacts/pv-caption-scenes-task8/) 与 [`联系表`](../../artifacts/pv-caption-scenes-task8-contact-sheet.png)；覆盖片头、正文“方庭”、有语义问号、长语义分句、球面总结与片尾。真实 Topo Serif 88px、白字 / 4px 黑描边，DOM 零高 marker 实测基线距底 180px；通用底部安全边界 144px，46 cue 可见字形下沿均距底 155px。6 帧均为单行且只显示一个 caption group，代表帧宽 1144–1672px，低于 3456px 安全宽。Task 8D manifest 绑定 214.040 秒 final voice 时间线与 `timing.json` SHA-256 `96aac8cda585915208f62c9f1f0ed4f96aa3994c00f340295e29d36aadd775ee`；全量 46 cue 的 seek、字宽、真实基线、字形 bbox、字体与可见组数均持久化在 [`manifest`](../../artifacts/pv-caption-scenes-task8-manifest.json)。联系表 SHA-256：`058082d19681391547188cb9f02b1f07100693e17342321ca6566db2c555996b`；本地另生成被忽略的 69 秒字幕专审视频 |
