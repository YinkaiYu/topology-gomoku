...
| 《足音回归》4K 单行字幕与底部基线 | [`6 cue 代表帧`](../../artifacts/pv-caption-scenes-task8/) 与 [`联系表`](../../artifacts/pv-caption-scenes-task8-contact-sheet.png)；覆盖片头、正文“方庭”、有语义问号、长语义分句、球面总结与片尾。真实 Topo Serif 88px、白字 / 4px 黑描边、底边 180px，6 帧均为单行且只显示一个 caption group；代表帧宽 1144–1672px，低于 3456px 安全宽。逐帧 seek、字宽、字体与可见组数见 [`manifest`](../../artifacts/pv-caption-scenes-task8-manifest.json)，全量 46 cue 由 Chromium 测试覆盖；联系表 SHA-256：`bea7256645f776f227905407424e79bd12d23a722a2382c4c8c74c433702b8e5`。本地另生成被忽略的 69 秒字幕专审视频 |
